...
namespace NINA.RetroKiwi.Plugin.SonyCameraPlugin.SonyCameraPluginDockables {
    /// <summary>
    ...
    public class SonyCameraPluginDockable : DockableVM, ITelescopeConsumer {
        private INighttimeCalculator nighttimeCalculator;
        private ITelescopeMediator telescopeMediator;

        [ImportingConstructor]
        public SonyCameraPluginDockable(
            ...
            dict.Source = new Uri("NINA.RetroKiwi.Plugin.SonyCameraPlugin;component/SonyCameraPluginDockables/SonyCameraPluginDockableTemplates.xaml", UriKind.RelativeOrAbsolute);
            ImageGeometry = (System.Windows.Media.GeometryGroup)dict["NINA.RetroKiwi.Plugin.SonyCameraPlugin_AltitudeSVG"];
